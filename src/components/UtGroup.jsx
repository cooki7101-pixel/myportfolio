...
export default function UtGroup({ photos = [], docs = [] }) {
  ...
  return (
    <section className="ut-group" data-node-id="360:5954">
      ...
      <p className="ut-group__result">
        테스트 결과, 구매자는 AI 검증과 안전결제를 통해 거래에 대한 신뢰를 느꼈으며 에스크로 구조도 별도 설명 없이도 쉽게 이해했습니다. 판매자는 복잡한 절차 없이 간편하게 등록할 수 있다는 점에서 긍정적인 반응을 보였습니다. SUS 점수 또한 평균 86.3점으로 우수한 사용성 평가를 받았습니다.
      </p>
