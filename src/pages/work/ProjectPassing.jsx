  ...
  return (
    <article className="project-passing" data-node-id="291:396" style={{ backgroundColor: '#DEE4F2' }}>
      ...
      <Hero
        ...
        mediaType="video"
        mediaSrc="/assets/hero-passing.mp4"
      />
      ...
      <div className="project-passing__body">
        ...
        <MainFeatures
          ...
          video={<video autoPlay muted loop playsInline preload="auto"><source src="/assets/passing/video-features1.mp4" type="video/mp4" /></video>}
        />
        <MainFeatures
          variant="reverse"
          ...
          video={<video autoPlay muted loop playsInline preload="auto"><source src="/assets/passing/video-features2.mp4" type="video/mp4" /></video>}
        />
        <MainFeatures
          variant="state"
          ...
          video={<video autoPlay muted loop playsInline preload="auto"><source src="/assets/passing/video-features3.mp4" type="video/mp4" /></video>}
        />
        ...
        <div className="project-passing__section project-passing__group project-passing__section--rounded">
          <ContentSection
            ...
            items={[{ src: '/assets/passing/img-passing-research1.svg' }]}
          />
          <ContentSection
            showEyebrow={false}
            title="왜 X(트위터)인가?"
            ...
            items={[{ src: '/assets/passing/img-passing-research2.svg', label: 'X(트위터)에서 일어나는 P2P 거래 실제 게시글' }, { src: '/assets/passing/img-passing-research3.svg' }]}
          />
        </div>
        ...
        <div className="project-passing__section">
          <ContentSection
            ...
            items={[{ src: '/assets/passing/img-passing-casestudy.svg' }]}
          />
        </div>
        ...
        <div className="project-passing__section">
          <ContentSection
            ...
            items={[{ src: '/assets/passing/img-passing-competitor.svg' }]}
          />
        </div>
        ...
        <div className="project-passing__section project-passing__group">
          <ContentSection
            ...
            items={[{ src: '/assets/passing/img-passing-interview.svg', label: "'참여자 A'와 인터뷰 과정" }]}
          />
          <InterviewBox />
        </div>
        ...
        <div className="project-passing__section">
          <ContentSection2
            ...
            items={[{ src: '/assets/passing/img-persona1.svg', label: '구매자 퍼소나' }, { src: '/assets/passing/img-persona2.svg', label: '판매자 퍼소나' }, { src: '/assets/passing/img-persona3.svg' }]}
          />
        </div>
        ...
        <div className="project-passing__section project-passing__section--rounded">
          <ContentSection
            ...
            items={[{ src: '/assets/passing/img-passing-brain.svg' }]}
          />
        </div>
        ...
        <div className="project-passing__section">
          <ContentSection2
            ...
            items={[{ src: '/assets/passing/img-passing-moscow1.svg', label: '구매자 모스코우' }, { src: '/assets/passing/img-passing-moscow2.svg', label: '판매자 모스코우' }]}
          />
        </div>
        ...
        <div className="project-passing__section project-passing__section--rounded">
          <ContentSection
            ...
            items={[{ src: '/assets/passing/img-passing-story.svg' }]}
          />
        </div>
        ...
        <div className="project-passing__section project-passing__group">
          <ContentSection2
            ...
            items={[{ src: '/assets/passing/img-passing-flow1.svg', label: '구매자 FLOW' }, { src: '/assets/passing/img-passing-flow2.svg', label: '판매자 FLOW' }]}
          />
          ...
          <div className="project-passing__feature-definition">
            ...
            <div className="project-passing__feature-definition-image">
              <img src="/assets/passing/img-passing-flow3.svg" alt="" />
            </div>
          </div>
        </div>

        <WireframeGroup image="/assets/passing/img-passing-wireframe.svg" />
        ...
        <div className="project-passing__section project-passing__section--rounded">
          <ContentSection
            ...
            items={[{ src: '/assets/passing/img-passing-prototype.svg' }]}
          />
        </div>
